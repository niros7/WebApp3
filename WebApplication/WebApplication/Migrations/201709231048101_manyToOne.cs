namespace WebApplication.Migrations
{
    ...
    public partial class manyToOne : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ReferencedPost_Id = c.Int(),
                    })
                .PrimaryKey(t => t.CommentId)
                .ForeignKey("dbo.AspNetUsers", t => t.CommentUser_Id)
                .ForeignKey("dbo.Posts", t => t.ReferencedPost_Id)
                .Index(t => t.CommentUser_Id)
                .Index(t => t.ReferencedPost_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Comments", "ReferencedPost_Id", "dbo.Posts");
            ...
            DropIndex("dbo.Comments", new[] { "ReferencedPost_Id" });
